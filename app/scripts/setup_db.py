...
def main():
    ...
    if not db_url:
        ...
        print("Format: postgresql://postgres:[your-password]@db.[your-project-id].supabase.co:5432/postgres")
    ...
    sql_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "core", "database", "init_db.sql"))
